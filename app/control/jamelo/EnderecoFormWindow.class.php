 ...
 */
class EnderecoFormWindow extends TWindow
{
    protected $form;      // form
    ...
    public function __construct($param)
    {
        ...
        parent::setTitle('Endereços do cliente');
      ...
      //  parent::removeTitleBar();
        ...
        if(!empty($param['system_user_id'])){
            ...
            TSession::setValue(__CLASS__.'system_user_id', $param['system_user_id']);
            
            $criteria = new TCriteria();
            $criteria->add(new TFilter('system_user_id','=', TSession::getValue(__CLASS__.'system_user_id')));
       ...
       // $this->form->addAction( 'Incluir endereço', new TAction([$this, 'onSave']), 'fas:arrow-right green');
    ...
    public function onSave($param){
           ...
           // run form validation
            ...
            AdiantiCoreApplication::loadPage('Resumo', 'onReload');
    }
