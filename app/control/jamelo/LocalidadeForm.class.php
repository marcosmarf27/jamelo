 ...
 */
class LocalidadeForm extends TPage
{
    protected $form;      // form
    ...
    public function __construct()
    {
        ...
        $this->setActiveRecord('Localidade'); // define the Active Record
        $this->setDefaultOrder('id', 'asc'); // define the default order
        $this->setLimit(-1); // turn off limit for datagrid
        
        // create the form
        $this->form = new BootstrapFormBuilder('form_localidade');
        $this->form->setFormTitle('Locais de atendimento');
        ...
        $this->form->addActionLink( 'Novo/limpar',new TAction([$this, 'onClear']), 'fa:eraser red');
